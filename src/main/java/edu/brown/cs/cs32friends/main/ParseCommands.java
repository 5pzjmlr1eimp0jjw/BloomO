...
public class ParseCommands {
  ...
  public ParseCommands() {
    ...
    this.commandMap.put("plant_zone", new ZipcodeHandler());
    this.commandMap.put("input_plant_image", new PlantImageHandler());
    this.commandMap.put("plant_load", new PlantLoaderHandler());
    this.commandMap.put("plant_recommend", new RecommenderHandler());
    this.commandMap.put("input_plant_image_robust", new PlantImageHandlerRobust());
  }
