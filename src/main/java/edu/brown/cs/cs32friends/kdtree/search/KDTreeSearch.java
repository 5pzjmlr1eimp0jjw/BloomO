package edu.brown.cs.cs32friends.kdtree.search;

import edu.brown.cs.cs32friends.kdtree.Node;
import edu.brown.cs.cs32friends.kdtree.coordinates.Coordinate;
import edu.brown.cs.cs32friends.kdtree.coordinates.KeyDistance;
...
or excluded within the List of IDs returned
    ...
    public List<Coordinate<T>> getNearestNeighborsResult(int k, Coordinate<T> targetPoint,
        ...
        performKdTreeSearchNeighbors(root, k, (Coordinate<T>) targetPoint, kNearestNeighborsQueue,
